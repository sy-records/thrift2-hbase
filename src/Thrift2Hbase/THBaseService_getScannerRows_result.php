...
class THBaseService_getScannerRows_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\Luffy\Thrift2Hbase\TResult',
                ),
        ),
        1 => array(
            'var' => 'io',
        ...
        2 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Luffy\Thrift2Hbase\TIllegalArgument',
        ),
    );

    /**
     * @var \Luffy\Thrift2Hbase\TResult[]
     */
    public $success = null;
    /**
     ...
     * 
     * @var \Luffy\Thrift2Hbase\TIllegalArgument
     */
    public $ia = null;
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i222 = 0; $_i222 < $_size218; ++$_i222) {
                            $elem223 = null;
                            $elem223 = new \Luffy\Thrift2Hbase\TResult();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->ia = new \Luffy\Thrift2Hbase\TIllegalArgument();

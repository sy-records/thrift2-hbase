...
class TMutation
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Luffy\Thrift2Hbase\TPut',
        ),
        2 => array(
            'var' => 'deleteSingle',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Luffy\Thrift2Hbase\TDelete',
        ),
    );

    /**
     * @var \Luffy\Thrift2Hbase\TPut
     */
    public $put = null;
    /**
     * @var \Luffy\Thrift2Hbase\TDelete
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->put = new \Luffy\Thrift2Hbase\TPut();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->deleteSingle = new \Luffy\Thrift2Hbase\TDelete();

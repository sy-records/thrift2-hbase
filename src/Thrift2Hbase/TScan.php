...
class TScan
{
    ...
    static public $_TSPEC = array(
        ...
        3 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\Luffy\Thrift2Hbase\TColumn',
                ),
        ),
        4 => array(
            'var' => 'caching',
        ...
        6 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Luffy\Thrift2Hbase\TTimeRange',
        ),
        7 => array(
            'var' => 'filterString',
            'isRequired' => false,
        ...
        10 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Luffy\Thrift2Hbase\TAuthorization',
        ),
        11 => array(
            'var' => 'reversed',
            'isRequired' => false,
    ...
    public $stopRow = null;
    /**
     * @var \Luffy\Thrift2Hbase\TColumn[]
     */
    public $columns = null;
    /**
     * @var int
    ...
    /**
     * @var \Luffy\Thrift2Hbase\TTimeRange
     */
    ...
    /**
     * @var \Luffy\Thrift2Hbase\TAuthorization
     */
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i98 = 0; $_i98 < $_size94; ++$_i98) {
                            $elem99 = null;
                            $elem99 = new \Luffy\Thrift2Hbase\TColumn();
                ...
                case 6:
                    if ($ftype == TType::STRUCT) {
                        $this->timeRange = new \Luffy\Thrift2Hbase\TTimeRange();
                ...
                case 10:
                    if ($ftype == TType::STRUCT) {
                        $this->authorizations = new \Luffy\Thrift2Hbase\TAuthorization();
                ...
                case 13:
                    if ($ftype == TType::MAP) {
                        ...
                        for ($_i111 = 0; $_i111 < $_size107; ++$_i111) {
                            $key112 = '';
                            $val113 = new \Luffy\Thrift2Hbase\TTimeRange();
